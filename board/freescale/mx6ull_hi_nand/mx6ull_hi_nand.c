...
/* 网络PHY复位引脚 */
#define ENET1_RESET IMX_GPIO_NR(5, 6)
...
//init_sequence_f->board_early_init_f
...
//init_sequence_r->board_late_init
...
// init_sequence_f->show_board_info->checkboard
int checkboard(void)
{
/*
	if (is_mx6ull_9x9_evk())
...
*/
	puts("Board: MX6ULL 14x14 HI\n");

	return 0;
}

#ifdef CONFIG_FSL_FASTBOOT
//fastboot_setup(drivers\usb\gadget\f_fastboot.c)->board_fastboot_setup 
...
//下面所有的内容均为SPL_BUILD的内容，没有使用SPL_BUILD，所以不用分析
#ifdef CONFIG_SPL_BUILD
#include <libfdt.h>
#include <spl.h>
