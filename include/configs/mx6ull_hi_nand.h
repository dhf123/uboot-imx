 ...
 */
#ifndef __MX6ULL_HI_NAND_CONFIG_H
#define __MX6ULL_HI_NAND_CONFIG_H
...
#else
#define PHYS_SDRAM_SIZE		SZ_256M		///板载ddr为256M
	...
	"ip=dhcp nfsroot=${serverip}:${nfsroot},v3,tcp\0" \
		...
		"findfdt="\
			"if test $fdt_file = undefined; then " \
				...
				"if test $board_name = HI && test $board_rev = 14X14; then " \
					"setenv fdt_file zImage-imx6ull-14x14-evk-gpmi-weim.dtb; fi; " \
				"if test $fdt_file = undefined; then " \
...
*/
/* change 
offset 0x60_0000 uboot 0-10M env 从6M开始
size 128K
*/
...
/* #define CONFIG_PHY_MICREL	官方开发板使用的phy是MICREL系列的phy,自己的板子使用的是SMSC的lan8720*/
